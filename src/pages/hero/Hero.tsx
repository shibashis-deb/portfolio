...
export const Header = () => {
  return (
    <header className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <Div className="absolute top-1/4 left-1/4 w-72 h-72 bg-primary/20 rounded-full blur-3xl animate-[pulse_4s_ease-in-out_infinite]" />
      <Div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/15 rounded-full blur-3xl animate-[pulse_6s_ease-in-out_infinite]" />

      <section className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <h1 className="flex flex-row justify-center align-center gap-x-5 text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight">
              <span>Shibashis</span>
      ...
      {/* Scroll indicator */}
      <section className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
